    ...
    $(document).on('ready', function() {
        $('.data-grid').find('[data-editable-link]').each(function() {
            ...
            var onEdit = function(){
                ...
                switch(type) {
                    case 'number' :
                        input.val(old_value.replace(separator, '').replace(unit, ''));
                        break;
                    case 'date' :
                        input.val(old_value);
            ...
            $this.find('>table>tbody>tr>td[data-editable], >.tree-grid>ul li>div>span[data-editable]').on('dblclick.grid-editable', onEdit);

            $(window).on('ajaxComplete', function() {
                $this.find('>table>tbody>tr>td[data-editable]').off('dblclick.grid-editable', onEdit);
                $this.find('>table>tbody>tr>td[data-editable]').on('dblclick.grid-editable', onEdit);
            });
